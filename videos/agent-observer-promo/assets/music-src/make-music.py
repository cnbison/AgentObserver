...
RATE=48000; DURATION=50; N=RATE*DURATION
...
for t,n in [(47,74),(47.5,76),(48,78),(48.5,81)]:instrument(t,1.5,n,.1,'keys',.1)
def save(path,L,R):
    pcm=array.array('h')
    for i,(l,r) in enumerate(zip(L,R)):
        t=i/RATE;env=min(1,t/.025)*min(1,max(0,(50-t)/.65))
...
print('Created music.wav and music-raw.wav: 50s, stereo, 120 BPM. Adapted from skill example for GOSIM Agent Observer promo film; mix SFX separately.')
